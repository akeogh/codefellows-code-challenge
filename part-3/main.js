...
var crime = greenlake.checkOut("Crime and Punishment", 1);
var war = greenlake.checkOut("War and Peace", 2);
$('#checkOut').append(greenlake.toString() + "<br/> <br/> Checked out Books: <br/>" +
 crime.toString() + "<br/>" + war.toString() + "<br/>");

greenlake.checkIn(crime, 1);
greenlake.checkIn(war, 2);
$('#checkIn').append(greenlake.toString());
